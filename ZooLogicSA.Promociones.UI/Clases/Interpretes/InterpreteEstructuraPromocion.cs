...
namespace ZooLogicSA.Promociones.UI.Clases
{
    public class InterpreteEstructuraPromocion
    {
        ...
        public void ActualizarInformacion()
        {
            ...
            this.estructura.aplicacionProductosIguales = this.comboAplicacionProductosIguales.SelectedIndex < 0 ? 0 : this.comboAplicacionProductosIguales.SelectedIndex;
        }
        ...
        private void SetearValorAControles()
        {
            ...
            this.SetearValorAplicacionProductosIguales(this.estructura.aplicacionProductosIguales);
        }
...
//            this.mskCondicion.SetearValor( valor );
        ...
        private void SetearValorAplicacionProductosIguales(int valor)
        {
            if (this.comboAplicacionProductosIguales.Items.Count > valor)
                this.comboAplicacionProductosIguales.SelectedIndex = valor;
            else
