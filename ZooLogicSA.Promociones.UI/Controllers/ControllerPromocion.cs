...
namespace ZooLogicSA.Promociones.UI.Controllers
{
    public class ControllerPromocion : IControllerPromocion
    {
        ...
        private System.Windows.Forms.ComboBox comboAplicacionProductosIguales;
        private System.Windows.Forms.Panel panelAplicacionProductosIguales;
        ...
        public ControllerPromocion()
        {
            ...
            this.comboAplicacionProductosIguales = new System.Windows.Forms.ComboBox();
        }
        ...
        public void Inicializar( ListBox listaTipoPromocion, MaskPromocion maskBeneficio, MaskPromocion maskTopeDescuento,
                                ...
                                System.Windows.Forms.ComboBox comboAplicacionProductosIguales )
        {
            ...
            this.comboAplicacionProductosIguales = comboAplicacionProductosIguales;
            this.panelAplicacionProductosIguales = comboAplicacionProductosIguales.Parent as System.Windows.Forms.Panel;
            ...
            this.Interprete.Inicializar( this.lisTiposPromocion, this.mskCondicion, this.mskBeneficio, this.mskTopeDescuento,
                                        ...
                                        this.comboAplicacionProductosIguales );
        ...
        private void ActualizarControlesSegunTipoPromocion( TipoPromocion tp )
        {
            ...
            if ( this.panelAplicacionProductosIguales != null )
                this.panelAplicacionProductosIguales.Visible = true;
        ...
        private void OcultaControlesSegunTipoPromocion()
        {
            ...
            this.mskCuotasSinRecargo.Visible = false;
            if ( this.panelAplicacionProductosIguales != null )
                this.panelAplicacionProductosIguales.Visible = false;
        }
        ...
        public void MostrarVistaPredeterminada( bool tlEdicion, string valorAnterior )
        {
            ...
            if ( tlEdicion && valorAnterior != string.Empty )
            {
                ...
                int idxAplicacion = InterpreteXMLPromocion.ObtenerAplicacionProductosIgualesDesdeXML( valorAnterior );
                if ( idxAplicacion >= 0 && idxAplicacion < this.comboAplicacionProductosIguales.Items.Count )
                    this.comboAplicacionProductosIguales.SelectedIndex = idxAplicacion;
            }
        ...
        public void LimpiarControles()
        {
            ...
            this.aplicaAutomaticamente.Checked = false;
            if ( this.comboAplicacionProductosIguales != null && this.comboAplicacionProductosIguales.Items.Count > 0 )
                this.comboAplicacionProductosIguales.SelectedIndex = 0;
        ...
        public ZooLogicSA.Promociones.FormatoPromociones.AplicacionProductosIgualesType ObtenerAplicacionProductosIguales()
        {
            int idx = this.comboAplicacionProductosIguales.SelectedIndex;
            if ( idx < 0 ) idx = 0;
            return (ZooLogicSA.Promociones.FormatoPromociones.AplicacionProductosIgualesType)idx;
        }
