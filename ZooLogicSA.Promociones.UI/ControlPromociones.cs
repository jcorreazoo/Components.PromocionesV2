        ...
        public string Value
        {
            ...
            set
            {
                if ( value != valueAnterior )
                {
                    ...
                    int idxAplicacion = InterpreteXMLPromocion.ObtenerAplicacionProductosIgualesDesdeXML( value );
                    if ( idxAplicacion >= 0 && idxAplicacion < this.cmbIgualdadCondicion.Items.Count )
                        this.cmbIgualdadCondicion.SelectedIndex = idxAplicacion;
