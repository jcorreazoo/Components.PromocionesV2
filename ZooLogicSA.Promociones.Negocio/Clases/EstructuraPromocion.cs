...
namespace ZooLogicSA.Promociones.Negocio.Clases
{
    public class EstructuraPromocion
    {
        ...
        private const string cAplicacionProductosIguales = "APLICACIONPRODUCTOIGUALES";
        ...
        private int _aplicacionProductosIguales;
        ...
        { 
            ...
            this._aplicacionProductosIguales = 0;
        }
        ...
        public string Resultado
        {
            get
            {
                ...
                result += cSeparador + cAplicacionProductosIguales + cSeparadorLabel + _aplicacionProductosIguales;
        ...
        { 
            switch (atributo)
            {
                ...
                case cAplicacionProductosIguales:
                    {
                        int parsed;
                        this._aplicacionProductosIguales = int.TryParse(valor, out parsed) ? parsed : 0;
                        break;
                    }
            }
        }
        ...
        public int aplicacionProductosIguales
        {
            get { return _aplicacionProductosIguales; }
            set { _aplicacionProductosIguales = value; }
        }
    }
}
