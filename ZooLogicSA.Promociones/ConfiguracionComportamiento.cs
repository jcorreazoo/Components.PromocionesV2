...
namespace ZooLogicSA.Promociones
{
    public class ConfiguracionComportamiento
    {
        ...
        public ConfiguracionComportamiento()
        {
            ...
            this.configuracionesPorParticipante["COMPROBANTE.FACTURADETALLE.ITEM"].AtributoCodigoArticulo = "ARTICULO.CODIGO";
            this.configuracionesPorParticipante["COMPROBANTE.FACTURADETALLE.ITEM"].Combinacion = "COLOR.CODIGO;TALLE.CODIGO";
