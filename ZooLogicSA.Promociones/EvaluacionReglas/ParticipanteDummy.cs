...
namespace ZooLogicSA.Promociones.EvaluacionReglas
{
    public class ParticipanteDummy : IParticipante
    {
        ...
        {
            // Los dummies no tienen atributos XML; retornar null permite que los pre-scans
            // de PorArticulo y PorArticuloYCombinacion los detecten y los traten como
            // ítems "genéricos" que complementan la mejor combinación/artículo real.
            return null;
        }
