...
namespace ZooLogicSA.Promociones
{
    public class ConfiguracionPorParticipante
    {
        ...
        private string atributoCodigoArticulo;
        ...
        {
            get { return this.combinacion; }
            set { this.combinacion = value; }
        }

        /// <summary>
        /// Ruta de atributo XPath-style del código de artículo (p.ej. "Articulo.Codigo").
        /// Usado por PorArticuloYCombinacion para construir la clave de combinación.
        /// </summary>
        public string AtributoCodigoArticulo
        {
            get { return this.atributoCodigoArticulo; }
            set { this.atributoCodigoArticulo = value; }
        }
